"""Tests for Tuya HLS Camera api."""
import asyncio

import aiohttp
from custom_components.tuya_hls_camera.api import (
    TuyaHlsCameraApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = TuyaHlsCameraApiClient("test", "test", async_get_clientsession(hass))
